...
const tag_html_filename = "app/templates/html/tag.html";
const metric_html_filename = "app/templates/html/metric.html";
const metrics_form_html_filename = "app/templates/html/monitorings_form.html";
const default_metric = {metric: "proc.cpu.user", aggregator: "zimsum", tags: ["host=node0", "command=YarnChild"]};
const default_metrics_form = JSON.parse("{\"timeseries\":[{\"metrics\":[{\"metric\":\"proc.cpu.user\",\"aggregator\":\"zimsum\",\"tags\":[\"host=node1\"]}],\"yranges\":{\"ymin\":0,\"ymax\":800}}]}");
